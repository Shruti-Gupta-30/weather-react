	...
	return (
		<div className="hourly">
			<div className="row">
				...
				<div className="col-1 p-0"> {Math.round(forecast.hourly[0].temp)}°</div>
				...
				<div className="dropdown">
					...
					<div className="row mt-1 hourlyDetails">
						...
						<div className="col-2 p-0">
							...
							<div className="row">{forecast.hourly[0].humidity}%</div>
						</div>
						<div className="col-2 p-0">
						...
						<div className="col-2 p-0">
							...
							<div className="row">{forecast.hourly[0].pressure} mb</div>
						</div>
					</div>
				</div>
			)}
